...
function viewRecord(object, e) {
    ...
    $("#ContainerTypeID").val(object.ContainerTypeID);
...
function Disable() {
    ...
    $("#ContainerTypeID").attr("disabled", true);
...
function Enable() {
    ...
    $("#ContainerTypeID").attr("disabled", false);
...
function ChangeStatus(Id, status) {
    $.ajax({
        url: `../Admin/ChangeContainerStatus`,
        type: 'POST',
