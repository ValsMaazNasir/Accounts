...
function Disable() {
    ...
    $("#CustomerCompanyID").attr("readonly", true);
...
function Enable() {
    ...
    $("#CustomerCompanyID").attr("readonly", false);
...
function DeleteModel(Id) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: `../Admin/DeleteCustomerDepartment`,
                type: 'POST',
                data: { ID: Id },
...
function ChangeStatus(Id, status) {
    $.ajax({
        url: `../Admin/ChangeCustomerDepartmentStatus`,
        type: 'POST',
