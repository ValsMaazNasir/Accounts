function viewRecord(object, e) {
    ...
    $("#TrailerTypeID").val(object.TrailerTypeID);
...
function Disable() {
    ...
    $("#TrailerTypeID").attr("disabled", true);
}
...
function Enable() {
    ...
    $("#TrailerTypeID").attr("disabled", false);
}
