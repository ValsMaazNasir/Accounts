...
namespace LiquadCargoManagment.Areas.Accounts.Controllers
{
    public class BanksController : BaseController
    {
        ...
        public JsonResult Listener(DTParameters param)
        {
            ...
            {
                dataSource = Database.ChartOfAccounts.Where(o => o.IsDeleted == false && o.Name.ToLower().Contains("bank")).AsQueryable();
            }
            else
            {
                dataSource = Database.ChartOfAccounts.Where(o => o.IsDeleted == false && o.Name.ToLower().Contains("bank") && o.CreatedBy == CurrentUserRecord.ID).AsQueryable();
            }
